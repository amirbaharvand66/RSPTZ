...
syms U__0mn V__0mn W__0mn X__mn Y__mn
...
assumeAlso(m > 0);
assumeAlso(n > 0);
assume([U__0mn V__0mn W__0mn X__mn Y__mn], 'real');
...
% displacement
[displ, vars] = displ(a, b, m, n, x, y, U__0mn, V__0mn, W__0mn, X__mn, Y__mn);
...
[lam] = result_f_m_collecter(scf, n_layup, x, y, z, Z, lam, theta, tre_elas);
